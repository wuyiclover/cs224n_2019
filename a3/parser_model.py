...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden = nn.Linear(self.embed_size*self.n_features, hidden_size) #input self.embed_size*self.n_features
    ...
    def forward(self, t):
        ...
        h_relu = nn.functional.relu(h)
        h_relu_dropout = self.dropout(h_relu)
        logits = self.hidden_to_logits(h_relu_dropout)
